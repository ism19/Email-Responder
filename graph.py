...
graph.add.node("classify_email", classify_email)
graph.add.node("rag_lookup", rag_lookup)
graph.add.node("make_decision", make_decision)
graph.add.node("draft_reply", draft_reply)
graph.add.node("escalate", escalate)

graph.set_entry_point("classify_email", classify_email)
